  ...
  <body>
    ...
    <script type="text/javascript">
        ...
        if (mensaje == '1') {
          ...
          swal(';(','Fallo al momento de agregar!','error');
      }else if (mensaje == '2'){
        swal(':D','Se actualizo correctamente!','success');
    }else if (mensaje == '3'){
      swal('XXXX','Fallo la actualización!','error');
    }else if (mensaje == '4'){
      swal('B)','Se Elimino correctamente!','success');
  }else if (mensaje == '5'){
